...
cp .env.examples .env
nano .env  # Отредактируйте данные

# 3. Добавьте дополнительные файлы (см. раздел "Дополнительные файлы")

# 4. Автоматическое развертывание
./deploy.sh

# 5. Настройка HTTPS (если есть домен)
./setup-https.sh
```
...
├── setup-https.sh              # Скрипт настройки HTTPS
